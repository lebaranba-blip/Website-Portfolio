      ...
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[360px_1fr_1fr] gap-10 lg:gap-14 relative z-10 items-start">
        ...
        <div className="flex flex-col gap-8">
          ...
          <motion.div
            ...
            suppressHydrationWarning
          >
            <p>Начинал с&nbsp;автобизнеса — снимал машины, ставил свет, кадрировал. Потом пришли нейросети. Nano Banana, Kling — работаю с&nbsp;ними как оператор: знаешь чего хочешь — получаешь результат. Не&nbsp;знаешь — красивый мусор.</p>
            <p>Параллельно строю автоматизации. Ноды, AI-агенты, Claude Code. Не&nbsp;потому что&nbsp;модно — просто когда рутина уходит в&nbsp;систему, голова освобождается.</p>
            <p>DaVinci, Photoshop, Figma — руками всё равно нужно уметь. Нейросеть не&nbsp;скроет что&nbsp;ты не&nbsp;понимаешь что&nbsp;делаешь.</p>
            <p>Бриф — хорошо. Но&nbsp;я обычно копаю глубже. Клиент не&nbsp;всегда сразу понимает — потом говорит: да, вот это оно.</p>
          </motion.div>
